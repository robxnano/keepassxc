...
QVector<PasswordGroup> PasswordGenerator::passwordGroups() const
{
    ...
    if (m_classes & Braces) {
        ...
        // ()[]{}
        group.append(QLatin1Char(40));
        group.append(QLatin1Char(41));
        group.append(QLatin1Char(91));
        group.append(QLatin1Char(93));
        group.append(QLatin1Char(123));
        group.append(QLatin1Char(125));
    ...
    if (m_classes & Punctuation) {
        ...
        // .,:;
        group.append(QLatin1Char(44));
        group.append(QLatin1Char(46));
        group.append(QLatin1Char(58));
        group.append(QLatin1Char(59));
    ...
    if (m_classes & Quotes) {
        ...
        // "'
        group.append(QLatin1Char(34));
        group.append(QLatin1Char(39));
    ...
    if (m_classes & Dashes) {
        ...
        // -/\_|
        group.append(QLatin1Char(45));
        group.append(QLatin1Char(47));
        group.append(QLatin1Char(92));
        group.append(QLatin1Char(95));
        if (!(m_flags & ExcludeLookAlike)) {
            group.append(QLatin1Char(124)); // "|"
        }
    ...
    if (m_classes & Math) {
        ...
        // !*+<=>?
        group.append(QLatin1Char(33));
        group.append(QLatin1Char(42));
        group.append(QLatin1Char(43));
        group.append(QLatin1Char(60));
        group.append(QLatin1Char(61));
        group.append(QLatin1Char(62));
        group.append(QLatin1Char(63));
    ...
    if (m_classes & Logograms) {
        ...
        // @^`~
        group.append(QLatin1Char(64));
        group.append(QLatin1Char(94));
        group.append(QLatin1Char(96));
        group.append(QLatin1Char(126));
